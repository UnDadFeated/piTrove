#!/usr/bin/env bash
# install.sh — piTrove v10.4.0 Premium Graphical Installer
...
banner() {
    clear
    echo -e "${CYAN}╔══════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${CYAN}║${NC}  ${BOLD}${WHITE}                  piTrove v10.4.0 Installation               ${NC}  ${CYAN}║${NC}"
...
cat > "$CONFIG_FILE" <<EOF
# ==========================================
# piTrove Configuration File (v10.4.0)
# ==========================================
