...
<option value="300">300s (5m)</option></select></div>
                    ...
                    <div>
                        ...
                        <div class="form-grid" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 0.8rem; margin-bottom: 0.6rem;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="set-news-blacklist" placeholder="e.g. realtor.com, legacy.com, legacy obituary" style="width:100%; padding:0.4rem; border-radius:8px; border:1px solid var(--card-border); background:var(--card-bg); color:var(--text-main);">
                            </div>
                        </div>
    ...
    <script>
        ...
        async function saveSettings() {
            ...
            const newsBl = document.getElementById('set-news-blacklist') ? encodeURIComponent(document.getElementById('set-news-blacklist').value) : "realtor.com, legacy.com, legacy obituary";
